const data = [
  {
    ...
    extraInfo: {
      imageSource:
        "https://www.canva.com/design/DAF5m8QT6AQ/YcmdwNC1ccb9Edu-GefCRg/edit",
    },
  },
  {
    id: "002",
  ...
  },
  {
    ...
    name: "Virginia Woolf",
    shortDescription:
      "Escritora británica modernista, pionera en la técnica narrativa.",
    description:
      "Virginia Woolf (1882-1941), novelista y ensayista británica, es una de las figuras más influyentes del modernismo literario. Su obra, que incluye 'La señora Dalloway' y 'Al faro', destaca por su exploración psicológica y experimentación narrativa. Woolf, co-fundadora del grupo literario Bloomsbury, abordó temas como la condición de la mujer y la naturaleza efímera de la vida. Su prosa innovadora y su enfoque en la conciencia individual la han establecido como una pionera literaria. A pesar de los desafíos personales, su legado perdura, influyendo en generaciones de escritores y destacando su contribución duradera a la literatura moderna.",
  ...
  },
  {
    ...
    name: "Isabel Allende",
    shortDescription:
      "Escritora chilena conocida por su realismo mágico y sus novelas históricas.",
    description:
      "Isabel Allende es una destacada escritora cuya obra ha cautivado la atención mundial. Reconocida por su estilo de realismo mágico y sus narrativas históricas, algunas de sus obras más conocidas incluyen 'La casa de los espíritus' y 'Eva Luna'. Allende ha dejado una marca indeleble en la literatura contemporánea latina, tejiendo historias emotivas y complejas que abordan temas sociales y políticos. A lo largo de su carrera, ha recibido numerosos premios, destacando su contribución a la literatura latinoamericana y su dedicación a la justicia social.",
  ...
  },
  {
    ...
    shortDescription:
      "Novelista británica, autora de la célebre obra 'Jane Eyre'.",
    description:
  ...
  },
  {
    ...
    shortDescription:
      "Poeta chilena y diplomática, primera latinoamericana en recibir el Premio Nobel de Literatura.",
    description:
      "Gabriela Mistral, seudónimo de Lucila de María del Perpetuo Socorro Godoy Alcayaga, fue una destacada poeta chilena y diplomática. Nació el 7 de abril de 1889 en Vicuña, Chile, y falleció el 10 de enero de 1957. Mistral fue la primera latinoamericana en recibir el Premio Nobel de Literatura, otorgado en 1945. Su obra poética aborda temas como la maternidad, la naturaleza y la injusticia social. Algunas de sus obras más conocidas incluyen 'Desolación' y 'Lagar'. Además de su labor literaria, Mistral se destacó como educadora y diplomática, representando a Chile en diversos países.",
  ...
  },
  {
    ...
    shortDescription:
      "Poeta y novelista nicaragüense-salvadoreña, destacada en la literatura centroamericana.",
    description:
  ...
  },
  {
    ...
    shortDescription:
      "Poeta estadounidense, conocida por su poesía innovadora.",
    description:
  ...
  },
  {
    ...
    shortDescription:
      "Escritora nigeriana conocida por sus obras feministas y sociales.",
    description:
  ...
  },
  {
    ...
    name: "Maya Angelou",
    shortDescription:
      "Poeta, cantante y activista estadounidense, figura clave del movimiento de derechos civiles.",
    description:
      " Maya Angelou (1928-2014), poetisa, escritora y activista estadounidense, es una luminaria de la literatura y los derechos civiles. Su autobiografía 'Yo sé por qué canta el pájaro enjaulado' es una odisea emocional que explora la superación personal y la lucha contra la discriminación racial y de género. Angelou, con una prosa poética única, ha dejado un legado poderoso que abarca desde su papel como poeta laureada de EE. UU. hasta su contribución a la música y el teatro. Su voz resonante y su impacto duradero la consolidan como una figura inolvidable en la historia cultural y literaria estadounidense.",
  ...
  },
  {
    ...
    name: "Zadie Smith",
    shortDescription:
      "Escritora británica, autora de 'Dientes blancos' y 'Sobre la belleza'.",
    description:
  ...
  },
  {
    ...
    name: "Yaa Gyasi",
    shortDescription:
      "Escritora ghanesa-estadounidense, autora de 'Cántame, oh musa'.",
    description:
      "Yaa Gyasi, nacida en Ghana en 1989, es una talentosa novelista estadounidense. Su aclamada obra 'Hijos de la Yoruba' la catapultó a la escena literaria mundial. Gyasi, con maestría narrativa, explora la herencia y la diáspora africana a través de generaciones. La novela, que abarca siglos y continentes, examina temas profundos como la esclavitud, la identidad y la conexión humana. Gyasi ha recibido elogios por su habilidad para tejer historias impactantes con riqueza histórica. Su contribución a la literatura contemporánea la ha establecido como una voz destacada, revelando la complejidad de la experiencia africana y afroamericana.",
  ...
  },
  {
    ...
    name: "Piedad Bonnet",
    shortDescription:
      "Poeta y novelista colombiana, conocida por su obra lírica y emotiva.",
    description:
      "Piedad Bonnett, nacida en Amalfi, Colombia, en 1951, es una destacada poetisa, dramaturga y novelista. Su obra poética, que incluye 'Explicaciones no pedidas' y 'Lo que no tiene nombre', refleja una exploración íntima de la vida, la pérdida y la memoria. Bonnett, reconocida por su sensibilidad y profundidad emocional, ha recibido numerosos premios literarios. Además de su contribución a la poesía colombiana contemporánea, su incursión en la prosa ha consolidado su posición como una figura influyente en la literatura latinoamericana, explorando la complejidad de la existencia humana con una voz distintiva y conmovedora.",
  ...
  },
  {
    ...
    name: "Laura Esquivel",
    shortDescription:
      "Escritora mexicana, autora de 'Como agua para chocolate'.",
    description:
      "Laura Esquivel, nacida en Ciudad de México en 1950, es una renombrada escritora y guionista mexicana. Su obra más conocida, 'Como agua para chocolate', fusiona la magia realista con la vida cotidiana, explorando temas como el amor y la cocina. Esquivel ha recibido reconocimiento internacional por su capacidad para mezclar lo mágico con lo mundano. Además de su éxito literario, ha incursionado en el cine y el teatro. Con una narrativa vibrante y emotiva, Esquivel ha dejado una marca duradera en la literatura latinoamericana, celebrando la conexión entre la gastronomía y las emociones con ingenio y originalidad.",
  ...
  },
  {
    ...
    name: "Gioconda Belli",
    shortDescription:
      "Poeta y novelista nicaragüense, figura destacada en la literatura contemporánea.",
    description:
      "Gioconda Belli, nacida en Managua, Nicaragua, en 1948, es una destacada poetisa y novelista reconocida por su compromiso político y su exploración de la condición femenina. Su obra, que incluye 'La mujer habitada' y 'El país bajo mi piel', refleja la fusión de la poesía con la narrativa, abordando temas sociales y de género. Belli, activista y revolucionaria, ha participado en movimientos por la justicia y los derechos de las mujeres. Su habilidad para entrelazar lo íntimo y lo político la ha establecido como una voz influyente en la literatura centroamericana contemporánea.",
